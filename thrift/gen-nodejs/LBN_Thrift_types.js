...
ttypes.LBN_SwitchType = {
'TYPE_1' : 0,
'TYPE_2' : 1,
'TYPE_3' : 2,
'TYPE_4' : 3
};
ttypes.LBN_ModuleType = {
'SQUARE_COLOR' : 0,
'MR16_WARM_WHITE' : 1,
'MR16_COOL_WHITE' : 2,
'STREET_WHITE' : 3,
...
stLBN_Thrift = module.exports.stLBN_Thrift = function(args) {
};
...
stLBN_ModuleControl = module.exports.stLBN_ModuleControl = function(args) {
  this.cwdimming = null;
  this.wwdimming = null;
  this.red = null;
  this.green = null;
...
stLBN_ModuleSensor = module.exports.stLBN_ModuleSensor = function(args) {
  this.ambient = null;
  this.red = null;
  this.green = null;
  this.blue = null;
...
stLBN_Group = module.exports.stLBN_Group = function(args) {
  this.id = null;
  if (args) {
...
stLBN_Scene = module.exports.stLBN_Scene = function(args) {
  this.id = null;
  this.title = null;
  if (args) {
    if (args.id !== undefined) {
...
stLBN_Module = module.exports.stLBN_Module = function(args) {
  this.id = null;
  this.type = null;
  this.control = null;
  this.groups = null;
...
stLBN_Module.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 5:
      if (ftype == Thrift.Type.STRUCT) {
        this.sensor = new ttypes.stLBN_ModuleSensor();
...
stLBN_Switch = module.exports.stLBN_Switch = function(args) {
  this.id = null;
  this.name = null;
  this.modules = null;
  this.scenes = null;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem14 = null;
          elem14 = new ttypes.stLBN_Module();
          elem14.read(input);
...
stLBN_Floor = module.exports.stLBN_Floor = function(args) {
  this.id = null;
  this.name = null;
  this.modules = null;
  if (args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem38 = null;
          elem38 = new ttypes.stLBN_Module();
          elem38.read(input);
...
stLBN_Area = module.exports.stLBN_Area = function(args) {
  this.id = null;
  this.name = null;
  this.floors = null;
  if (args) {
...
stLBN_DisasterInfo = module.exports.stLBN_DisasterInfo = function(args) {
  this.date = null;
...
stLBN_PowerMeter = module.exports.stLBN_PowerMeter = function(args) {
  this.hour = null;
  this.minute = null;
  this.second = null;
  this.dVoltage = null;
...
stLBN_PowerMeter.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
      if (ftype == Thrift.Type.DOUBLE) {
        this.dVoltage = input.readDouble();
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.DOUBLE) {
        this.dCurrent = input.readDouble();
      } else {
        input.skip(ftype);
      }
      break;
...
stLBN_PowerMeterOneDay = module.exports.stLBN_PowerMeterOneDay = function(args) {
  this.year = null;
  this.month = null;
  this.day = null;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem54 = null;
          elem54 = new ttypes.stLBN_PowerMeter();
          elem54.read(input);
...
stLBN_Schedule = module.exports.stLBN_Schedule = function(args) {
  this.id = null;
  this.time = null;
  this.scene = null;
  this.repeatAll = null;
...
stLBN_ContextRule = module.exports.stLBN_ContextRule = function(args) {
  this.id = null;
  this.title = null;
  this.description = null;
  this.scene = null;
...
stLBN_SolarInfo = module.exports.stLBN_SolarInfo = function(args) {
...
stLBN_SolarInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 5:
      if (ftype == Thrift.Type.DOUBLE) {
        this.elevation = input.readDouble();
      } else {
        input.skip(ftype);
      }
      break;
      case 6:
      if (ftype == Thrift.Type.I64) {
        this.sunriseTime = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 7:
      if (ftype == Thrift.Type.I64) {
        this.suntransitTime = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
...
stLBN_GraphData = module.exports.stLBN_GraphData = function(args) {
  this.title = null;
  this.values = null;
  if (args) {
    if (args.title !== undefined) {
...
stLBN_Chart = module.exports.stLBN_Chart = function(args) {
  this.title = null;
  this.data = null;
  this.xLabels = null;
  if (args) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem78 = null;
          elem78 = new ttypes.stLBN_GraphData();
          elem78.read(input);
...
stLBN_ParkingSensor = module.exports.stLBN_ParkingSensor = function(args) {
  this.floor = null;
  this.zone = null;
  this.slot = null;
  this.value = null;
...
stLBN_SchedulePreset = module.exports.stLBN_SchedulePreset = function(args) {
  this.id = null;
  this.title = null;
  if (args) {
    if (args.id !== undefined) {
